...
assert.equal(document.querySelectorAll('#overlay-navigation [data-open-panel]').length, 9);
assert.ok(document.querySelector('#overlay-navigation [data-open-panel="metamorphosis"]'), 'Metamorphosis must remain a first-class Hub destination');
